...
$query = $db->prepare("INSERT INTO `log_uye` (`id`, `kullaniciadi`, `sifre`, `adi_soy`, `email`, `tel_no`, `akt`, `ext`, `log_pin`, `cin_lo`) VALUES (NULL, :ka, :sif, :adis, :ema, :teln, :akt, :ext, :pinl, :cins)");
$insert = $query->execute(array(
':ka'=>$kul_adi,':sif'=>md5($sifre),':adis'=>$isim_so,':ema'=>$email,':teln'=>$tel_no,':akt'=>$akpa,':ext'=>$extt,':pinl'=>$pin_no,':cins'=>$cinss));
if ($insert){
...
<div class="w3-sidebar w3-bar-block w3-light-grey" style="width:20%">
  ...
  <a href="yor_lo.php" class="w3-bar-item w3-button">Yorum İşlemleri <span class="w3-tag w3-red w3-right w3-margin-right">
<?php echo $yorsa;?></span></a>
	<a href="kull_ek.php" class="w3-bar-item w3-button w3-red">Kullanıcı İşlemleri</a>
...
<input name="isim_so" class="w3-input w3-border" value="" type="text"  required>
</p>
<p>      
<label class="w3-text-grey">Kullanıcı Adı</label>
<input name="kull" class="w3-input w3-border" value="" type="text"  required>
</p>
<p>      
<label class="w3-text-grey">Email</label>
<input name="email" class="w3-input w3-border" value="" type="text"  required>
</p>
<p>  
<p>      
<label class="w3-text-grey">Telefon Numarası</label>
<input name="tel_no" class="w3-input w3-border" value="" type="text"  required>
</p>
<p>      
<label class="w3-text-grey">Pin</label>
<input name="pin_no" class="w3-input w3-border" value="<?php echo rand(100,999);echo rand(100,999); ?>" type="text"  required>
</p>
<p>
<label class="w3-text-grey">Şifre</label>
<input name="sifre" name="sifre_lo" class="w3-input w3-border" value="" type="text" required >
</p>
<p>
<label class="w3-text-grey">Extra Bilgiler (Önemli Durumlar İçin)</label>
<textarea name="extt" name="ext_lo" class="w3-input w3-border"  style="resize:none"></textarea>
</p>
<br>
  ...
  <div class="w3-half">
    ...
    <input id="male" class="w3-radio" type="radio" name="cins" value="Erkek" checked>
    <label>Erkek</label>
    <br>
...
<br>
	<p><button  type="submit" name="kis_ekkle" class="w3-btn w3-padding w3-red" style="width:120px">Kaydet &nbsp; &#10095;</button></p>
</form>
<br></br>
<div class="w3-container w3-red">
  <h2>Kullanıcılar</h2>
